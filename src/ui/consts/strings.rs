...
pub struct UiStringsSettingsPane {
    ...
    pub command_mode_leader_label: &'static str,
    pub command_mode_leader_footnote: &'static str,
    ...
    pub image_protocol_label: &'static str,
...
impl UiStrings {
    ...
    const fn settings_pane() -> UiStringsSettingsPane {
        UiStringsSettingsPane {
            ...
            command_mode_leader_label: "command_mode.leader: ",
            command_mode_leader_footnote: "Ctrl+letter opens Command Mode; j/k reserved for jump",
            ...
            image_protocol_label: "Image protocol: ",
